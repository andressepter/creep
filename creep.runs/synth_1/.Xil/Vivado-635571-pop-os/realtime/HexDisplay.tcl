...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-635571-pop-os/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_vhdl -lib xil_defaultlib {{/home/asepter/Insync/ansept@taltech.ee/OneDrive Biz/creep/creep.srcs/sources_1/new/creep.vhd}}
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification true
    set rt::SDCFileList ./.Xil/Vivado-635571-pop-os/realtime/HexDisplay_synth.xdc
    rt::sdcChecksum
    set rt::top HexDisplay
...
# MODE: 
    rt::set_parameter webTalkPath {/home/asepter/Insync/ansept@taltech.ee/OneDrive Biz/creep/creep.cache/wt}
    rt::set_parameter synthDebugLog false
    rt::set_parameter printModuleName false
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-635571-pop-os/"
